...
const UserAddedSuccessInlineNotification = () => {
...
const UserAddedSuccessNotification = () => toast((t) => (
    < UserAddedSuccessInlineNotification  />
), {
...
export default UserAddedSuccessNotification;
