...
const AddTransactionSuccessInlineNotification = () => {
...
const AddTransactionSuccessNotification = () => toast((t) => (
    < AddTransactionSuccessInlineNotification />
), {
...
export default AddTransactionSuccessNotification;
