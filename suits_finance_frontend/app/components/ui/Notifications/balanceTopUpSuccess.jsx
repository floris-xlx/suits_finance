...
const BalanceTopUpSuccessInlineNotification = () => {
...
const BalanceTopUpSuccessNotification = () => toast((t) => (
    < BalanceTopUpSuccessInlineNotification />
), {
...
export default BalanceTopUpSuccessNotification;
